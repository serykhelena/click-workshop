...
def main(name, age, pi, tags, optional, color, config, coordinates):  # noqa: PLR0913
    """
    Пример демонстрирует:
    - Использование встроенных типов (str, int, float)
    - Применение пользовательской функции для обработки значений
    - Использование click.Choice, click.File и multi-value options
    """
...
# python typing_argument_click.py John 25 --config config.txt
