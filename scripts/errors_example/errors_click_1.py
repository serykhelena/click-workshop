...
#   result_callback перехватывает результат выполнения команды
#       B классической ситуации мы возвращаем то, что перехватили
#       Если произошла ошибка, то настраиваем обработку самостоятельно
